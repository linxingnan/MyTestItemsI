...
void MyCombox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MyCombox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (MyCombox::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyCombox::clicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MyCombox::staticMetaObject = { {
    QMetaObject::SuperData::link<QComboBox::staticMetaObject>(),
    qt_meta_stringdata_MyCombox.data,
    qt_meta_data_MyCombox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
