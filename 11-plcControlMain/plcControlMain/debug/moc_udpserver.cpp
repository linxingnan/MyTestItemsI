...
QT_MOC_LITERAL(1, 10, 6), // "reData"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 6), // "buffer"
QT_MOC_LITERAL(4, 25, 14), // "findAllTimeOut"
QT_MOC_LITERAL(5, 40, 11), // "clearThread"
QT_MOC_LITERAL(6, 52, 8) // "readData"

    },
    "UdpServer\0reData\0\0buffer\0findAllTimeOut\0"
    "clearThread\0readData"
};
...
void UdpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->reData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->findAllTimeOut(); break;
        case 2: _t->clearThread(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpServer::reData)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpServer::findAllTimeOut)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (UdpServer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpServer::clearThread)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void UdpServer::reData(QString _t1)
{
...
// SIGNAL 1
void UdpServer::findAllTimeOut()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void UdpServer::clearThread()
{
