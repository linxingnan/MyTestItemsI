/****************************************************************************
** Meta object code from reading C++ file 'progressbardelegate.h'
**
...
#include <memory>
#include "../../plcControl/progressbardelegate.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'progressbardelegate.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject ProgressBarDelegate::staticMetaObject = { {
    QMetaObject::SuperData::link<QItemDelegate::staticMetaObject>(),
    qt_meta_stringdata_ProgressBarDelegate.data,
    qt_meta_data_ProgressBarDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
