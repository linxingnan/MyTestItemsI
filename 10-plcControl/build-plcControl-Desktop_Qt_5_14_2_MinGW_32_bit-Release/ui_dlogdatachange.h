...
public:
    ...
    void setupUi(QDialog *DLogDataChange)
    {
        ...
        label_2 = new QLabel(DLogDataChange);
        label_2->setObjectName(QString::fromUtf8("label_2"));

        horizontalLayout_3->addWidget(label_2);

        liEdPort = new QLineEdit(DLogDataChange);
        liEdPort->setObjectName(QString::fromUtf8("liEdPort"));

        horizontalLayout_3->addWidget(liEdPort);
    ...
    void retranslateUi(QDialog *DLogDataChange)
    {
        ...
        label_2->setText(QCoreApplication::translate("DLogDataChange", "\350\277\236\346\216\245\347\253\257\345\217\243\345\217\267", nullptr));
